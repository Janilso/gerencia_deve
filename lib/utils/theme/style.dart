...
const Color activeColor = const Color(0xFF44D83A);
const Color redColor = const Color(0xFFD60A0A);
const Color buttonStop = const Color(0xFFF44336);
const Color primaryColor = const Color(0xFFF58D25);
const Color secondary = const Color(0xFF1A1C35);
...
const Color orange = Color(0xFFD24A0B);
